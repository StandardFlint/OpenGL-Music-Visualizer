...
void main(){
    ...
    gl_Position = gl_in[2].gl_Position + orthogonalVector + vec4(_offset.x, _offset.y, 0.0, 0.0);
    EmitVertex();
    gl_Position = gl_in[2].gl_Position - orthogonalVector + vec4(_offset.x, _offset.y, 0.0, 0.0);
    EmitVertex();
    gl_Position = gl_in[3].gl_Position + orthogonalVector + vec4(_offset.x, _offset.y, 0.0, 0.0);
    EmitVertex();
    gl_Position = gl_in[3].gl_Position - orthogonalVector + vec4(_offset.x, _offset.y, 0.0, 0.0);
    EmitVertex();
